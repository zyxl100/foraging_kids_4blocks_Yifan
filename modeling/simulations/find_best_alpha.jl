...
function explore_parameter_space(alpha, n_samples=1000)
    ...
    for i in 1:n_samples
        ...
        gamma_coef = rand() * (gamma_coef_bounds[2] - gamma_coef_bounds[1]) + gamma_coef_bounds[1]
...
function main()
    ...
    serialize(string("results/parameter_space_results_alpha_",string(alpha),".ser"), results)
end
