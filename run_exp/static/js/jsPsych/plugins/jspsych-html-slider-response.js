...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '">';
    html += '<img src="run_exp/static/images/task_images/planet-01.jpg" align="left" style="width:8%;"><img src="run_exp/static/images/task_images/planet-02.jpg" align="right" style="width:8%;"><input type="range" value="'+trial.start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" id="jspsych-html-slider-response-response"></input>';
    html += '<div>'
    ...
    display_element.querySelector('#jspsych-html-slider-response-response').addEventListener('change', function(){
      ...
      if (response.response > 80 || response.response < 20)  {
        end_trial();
      }
    })
